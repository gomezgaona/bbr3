...
def plot_timing():
    ...
    tput_flow_2 = []
    for bdp in BDP:
        tput_flow_1.append(extract_iperf_summary(f'json_files/h1_cubic_{bdp}BDP_out.json'))
        tput_flow_2.append(extract_iperf_summary(f'json_files/h2_bbr_{bdp}BDP_out.json'))
    ...
    #Plot legends
    plt[0].legend(loc="upper right", fontsize=f_size)
    ...
    fig.savefig("BDP_1G.pdf", bbox_inches='tight')
