...
def plot_timing():
    ...
    tput_flow_2 = []
    for bdp in BDP:
        tput_flow_1.append(extract_iperf_summary(f'RTT_Unfairness_1G_20_100_FQ_Codel/h1_bbr_{bdp}BDP_out.json'))
        tput_flow_2.append(extract_iperf_summary(f'RTT_Unfairness_1G_20_100_FQ_Codel/h2_bbr_{bdp}BDP_out.json'))
    ...
    plt[1].semilogx(BDP, tput_flow_1,'#2D72B7', linewidth=2, label='20ms',marker ='o')
    plt[1].semilogx(BDP, tput_flow_2,'#95253B', linewidth=2, label='100ms',marker ='o')
    ...
    fig.savefig("RTT_Unfariness_1G_20_100_FQ-Codel.pdf", bbox_inches='tight')
